...
const LogIn: FunctionComponent = () => {
  return (
    <div className="relative bg-monochrome-white w-full h-[1024px] overflow-hidden text-left text-lg text-monochrome-white font-body-body-2">
      <div className="absolute top-[0px] left-[704px] bg-blue-blue-600 w-[736px] h-[1024px] text-center">
      ...
      <div className="absolute top-[372px] left-[152px] flex flex-col items-start justify-start gap-[16px] text-13xl text-grey-grey-900-p">
      ...
      <div className="absolute bottom-[40px] left-[calc(50%_-_421px)] flex flex-col items-center justify-start gap-[8px] text-base text-grey-grey-300-s font-mobile-body-subtitle-2">
