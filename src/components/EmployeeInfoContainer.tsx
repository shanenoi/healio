...
const EmployeeInfoContainer: FunctionComponent<EmployeeInfoContainerType> = ({
  ...
  return (
    <div className="absolute top-[calc(50%_-_328px)] left-[calc(50%_-_350px)] rounded-2xl bg-monochrome-white flex flex-row py-0 px-8 items-start justify-start text-center text-sm text-neutral-grey-700 font-body-body-2">
