...
interface EmployeeDataContainerType {
  maskGroup?: string
  rightIcon?: string
  xRegular?: string
  leftIcon?: string
                        ...
                        <div className="self-stretch flex flex-row items-start justify-start gap-[16px]">
                            ...
                            <div className="w-[310px] flex flex-col items-start justify-start gap-[8px]">
                                ...
                                <div className="relative w-14 h-[26px]">
                                    <div
                                        className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-81xl bg-blue-blue-400"/>
                                    <div
                                        className="absolute h-[76.92%] w-[35.71%] top-[11.54%] right-[5.36%] bottom-[11.54%] left-[58.93%] rounded-[50%] bg-monochrome-white"/>
                                </div>
                            </div>
                        </div>
