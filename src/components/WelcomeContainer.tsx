  ...
  return (
    <div className="flex flex-col items-start justify-start gap-[24px] text-left text-base text-grey-grey-900-p font-mobile-body-subtitle-2">
      <div className="w-[400px] flex flex-col items-start justify-start gap-[8px]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[4px] text-grey-grey-300-s font-button-button-2">
      ...
      <div className="rounded-xl bg-blue-blue-300 w-[400px] h-12 flex flex-row py-2 px-4 box-border items-center justify-center gap-[8px] text-center text-monochrome-white font-button-button-2">
