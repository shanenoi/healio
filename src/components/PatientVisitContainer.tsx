...
const PatientVisitContainer: FunctionComponent<PatientVisitContainerType> = ({
  ...
  return (
    <div className="absolute top-[224px] left-[32px] w-[437px] flex flex-col items-start justify-start gap-[80px] text-left text-29xl text-neutral-neutral-6 font-button-button-2">
