...
const EmployeeInfoCard: FunctionComponent<EmployeeInfoCardType> = ({
  ...
  return (
    <div className="absolute top-[calc(50%_-_482px)] left-[calc(50%_-_350px)] rounded-2xl bg-monochrome-white flex flex-row py-0 px-8 items-start justify-start text-center text-sm text-neutral-grey-700 font-body-body-2">
        ...
        <div className="self-stretch flex flex-row items-start justify-between text-blue-blue-400">
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-[16px]">
            ...
            <div className="rounded-lg bg-monochrome-white box-border h-8 flex flex-row py-2 px-4 items-center justify-center gap-[8px] border-[1px] border-solid border-blue-blue-400">
              <img className="relative w-4 h-4" alt="" src="/lefticon11.svg" />
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[16px] text-xs text-grey-grey-900-p">
            ...
            <div className="self-stretch flex flex-row items-start justify-start gap-[16px]">
              ...
              <div className="w-[310px] flex flex-col items-start justify-start gap-[6px]">
                ...
                <div className="bg-monochrome-white shadow-[0px_2px_8px_rgba(0,_0,_0,_0.1)] h-[348px] flex flex-col py-2 px-0 box-border items-center justify-center gap-[16px] text-center text-lg">
                  <div className="w-[358px] flex flex-row py-0 px-4 box-border items-center justify-between">
                    <img
                  ...
                  <div className="flex flex-col items-start justify-start gap-[8px] text-sm">
                    <div className="w-[358px] h-10 flex flex-row py-0 px-4 box-border items-center justify-center text-blue-blue-400">
                      <div className="self-stretch w-[46px] flex flex-row p-2.5 box-border items-center justify-center">
                    ...
                    <div className="w-[358px] h-10 flex flex-row py-0 px-4 box-border items-center justify-center">
                      <div className="self-stretch w-[46px] flex flex-row p-2.5 box-border items-center justify-center text-grey-grey-40-t">
                      ...
                      <div className="self-stretch w-[46px] flex flex-row p-2.5 box-border items-center justify-center">
                        <div className="rounded-xl box-border w-[30px] h-[30px] flex flex-col items-center justify-center border-[1px] border-solid border-blue-blue-400">
                    ...
                    <div className="bg-monochrome-white w-[358px] h-10 flex flex-row py-0 px-4 box-border items-center justify-center">
                      <div className="self-stretch w-[46px] flex flex-row py-2 px-4 box-border items-center justify-center">
                        <div className="relative leading-[150%]">12</div>
                      </div>
                      <div className="self-stretch w-[46px] flex flex-row py-2.5 px-4 box-border items-center justify-center">
                        <div className="relative leading-[150%]">13</div>
                      </div>
                      <div className="self-stretch rounded-tl-xl rounded-tr-none rounded-br-none rounded-bl-xl bg-monochrome-white w-[46px] flex flex-row py-0 px-4 box-border items-center justify-center text-monochrome-white">
                        <div className="rounded-xl bg-blue-blue-400 w-[30px] h-[30px] flex flex-col items-center justify-center">
                          <div className="relative leading-[150%]">14</div>
                        </div>
                      </div>
                      <div className="self-stretch bg-monochrome-white w-[46px] flex flex-row py-2.5 px-4 box-border items-center justify-center">
                        <div className="relative leading-[150%]">15</div>
                      </div>
                      <div className="self-stretch bg-monochrome-white w-[46px] flex flex-row p-2.5 box-border items-center justify-center">
                        <div className="relative leading-[150%]">16</div>
                      </div>
                      <div className="self-stretch bg-monochrome-white w-[46px] flex flex-row p-2.5 box-border items-center justify-center">
                        <div className="relative leading-[150%]">17</div>
                      </div>
                      <div className="self-stretch rounded-tl-none rounded-tr-xl rounded-br-xl rounded-bl-none bg-monochrome-white w-[46px] flex flex-row p-2.5 box-border items-center justify-center">
                        <div className="relative leading-[150%]">18</div>
                      </div>
                    </div>
                    <div className="w-[358px] h-10 flex flex-row py-0 px-4 box-border items-center justify-center">
                      <div className="self-stretch rounded-tl-xl rounded-tr-none rounded-br-none rounded-bl-xl bg-monochrome-white w-[46px] flex flex-row items-center justify-center">
                        <div className="relative leading-[150%]">19</div>
                      </div>
                      <div className="self-stretch bg-monochrome-white w-[46px] flex flex-row items-center justify-center">
                      ...
                      <div className="self-stretch rounded-tl-none rounded-tr-xl rounded-br-xl rounded-bl-none bg-monochrome-white w-[46px] flex flex-row items-center justify-center">
                    ...
                    <div className="w-[358px] h-10 flex flex-row py-0 px-4 box-border items-center justify-center">
                      ...
                      <div className="self-stretch rounded-tl-none rounded-tr-xl rounded-br-xl rounded-bl-none bg-monochrome-white w-[46px] flex flex-row py-0 px-2.5 box-border items-center justify-center">
                        <div className="rounded-xl bg-monochrome-white w-[30px] h-[30px] overflow-hidden shrink-0 flex flex-col p-2.5 box-border items-center justify-center">
