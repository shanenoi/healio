...
const EmployeeInfoCard: FunctionComponent<EmployeeInfoCardType> = ({
  ...
  return (
    <div className="absolute top-[calc(50%_-_482px)] left-[calc(50%_-_350px)] rounded-2xl bg-monochrome-white flex flex-row py-0 px-8 items-start justify-start text-center text-sm text-neutral-grey-700 font-button-button-2">
